...
MSG.tutorials.socialrobot['introduction'].stepContents = [
  "In diesem Tutorial machst du sich an die Arbeit, deinen eigenen sozialen Roboter zu entwerfen. Du wirst entdecken, was du mit dem <b>Simulator</b> machen kannst. <br><img class='tutorial' src='./../../app/static/img/tutorials/socialrobot/socialrobot.png'><br><!--Danach kannst du die folgenden Tutorials durchgehen, um Schritt für Schritt zu lernen, wie du deinen eigenen persönlichen Roboter baust.-->",
  ...
  "Nachdem du einen Block hinzugefügt hast, kannst du ihn hier an eine andere Stelle ziehen. Auf diese Weise kannst du entscheiden, wie dein Roboter aussieht. <br><br>Fahre mit der Maus über den neuen Block und ziehe den Roboter mit der <img class='tutorial' src='./../../app/static/img/tutorials/socialrobot/drag.jpg' width='20px'>.",
